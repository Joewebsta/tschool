...
class ArraysTest < Minitest::Test
  ...
  def test_4
    ...
    world_cup[world_cup.length - 1] = 'Japan'
  ...
  def test_a
    ...
    assert_equal %w[Germany Mexico Iceland], world_cup
  end
  ...
  def test_b
    ...
    band.unshift('Vocals')
    assert_equal %w[Vocals Guitar Drums Bass], band
  end
  ...
  def test_c
    ...
    assert_equal %w[Tomatoes Basil Peppers], garden
  ...
  def test_8
    ...
    assert_equal %w[Squirtle Charmander Bulbasaur Pikachu Staryu], pokemon
  end
  ...
  def test_10
    ...
    vowels.delete('y')
    assert_equal %w[a e i o u], vowels
  end
  ...
  def test_11
    ...
    assert_equal %w[couch dresser bed table], new_furniture
  end
