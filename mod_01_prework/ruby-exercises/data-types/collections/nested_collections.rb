...
class NestesdCollectionsTest < Minitest::Test
  ...
  def test_13
    three_day_forecast = { days: [{ high: 70, low: 63, summary: 'Mostly Sunny' }, { high: 55, low: 47, summary: 'Partly Cloudy' }, { high: 77, low: 64, summary: 'Sunny' }], 'date' => '6-21-18', ref_num: 3_456_789_765_456_787_656 }
    # Using the three_day_forecast variable defined above,
    # retrieve the expected piece of information
  ...
  def test_19
    ...
    expected = { days: [{ high: 99, low: 63, summary: 'Mostly Sunny' }, { high: 55, low: 47, summary: 'Partly Cloudy' }, { high: 77, low: 64, summary: 'Sunny' }], 'date' => '6-21-18', ref_num: 3_456_789_765_456_787_656 }
  ...
  def test_20
    ...
    expected = { 'time' => '12:30', days: [{ high: 70, low: 63, summary: 'Mostly Sunny' }, { high: 55, low: 47, summary: 'Partly Cloudy' }, { high: 77, low: 64, summary: 'Sunny' }], 'date' => '6-21-18', ref_num: 3_456_789_765_456_787_656 }
    assert_equal expected, three_day_forecast
  end
end
